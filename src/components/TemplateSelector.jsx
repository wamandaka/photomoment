        ...
        {TEMPLATES.map((tmpl) => {
          ...
          return (
            <button
              ...
              className={`p-3 rounded-2xl border-2 text-left transition-all duration-150 flex flex-col justify-between ${
                isSelected
            ...
            >
              ...
              <div>
                <p className="text-xs font-extrabold text-base-content tracking-tight">
                  {tmpl.name}
                </p>
