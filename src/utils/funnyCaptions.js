...
export const TEMPLATE_SPECIFIC_CAPTIONS = {
  newspaper: [
    ...
    'KAMU BLUBERRY & AKU PASTRY 🥐🫐',
    'BREAKING NEWS: SEDANG SANGAT BAHAGIA ✨',
    'KENANGAN TERBAIK DI DALAM MOMEN ITU ♡',
    'SPECIAL EDITION: MEMORY OF A LIFETIME 🗞️',
    'NOW PLAYING: FOTO KITA BLUR - SAL PRIADI 🎵',
  ],
  'wedding-love': [
